...
class _RegisterViewState extends State<RegisterView> {
  ...
  registerTenant(String firstName, String lastName, String otherNames, String phone, String email, String password) async {
  Map data = {
      ...
      padding: const EdgeInsets.all(10),
        ...
        Padding( 
           ...
           Padding(
            ...
            const Text("AGREE TO TERMS AND CONDITIONS",textAlign: TextAlign.center,),
             const SizedBox(
              height: 20,
           ),
             Container(
